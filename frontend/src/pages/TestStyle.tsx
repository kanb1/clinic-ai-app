...
const TestStyle = () => {
  return (
    <VStack gap={6} p={10}>
      <Heading textStyle="heading1" fontWeight="extrabold" fontFamily="heading">
        Heading 1
      </Heading>
      <Heading textStyle="heading2" fontWeight="medium" fontFamily="heading">
        Heading 2
      </Heading>
      <Heading
        textStyle="heading3"
      ...
      <Text textStyle="body" fontWeight="normal" fontFamily="body">
        This is body text
      </Text>
